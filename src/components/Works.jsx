...
const Page = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: "ZkSpin",
      description: "Developed the frontend for zkspin, an infinitely scalable on-chain game engine, during a freelancing project. My work focused on creating a seamless user experience and integrating advanced features that leverage the unique capabilities of blockchain technology.",
  ...
  return (
    <div className="bg-black text-white h-full lg:min-h-screen">
